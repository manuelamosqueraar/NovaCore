...
const container = document.querySelector('#loginModal .container');
...
const googleButtons = document.querySelectorAll('#loginModal .social-btn.google');
googleButtons.forEach(btn => {
    btn.addEventListener('click', (e) => {
        e.preventDefault();
        alert('¡El JavaScript sí funciona y detecta el clic!');
    });
});

const appleButtons = document.querySelectorAll('#loginModal .social-btn.apple');
appleButtons.forEach(btn => {
    btn.addEventListener('click', (e) => {
        e.preventDefault();
        e.stopPropagation();
        window.location.assign('https://appleid.apple.com');
    });
});
